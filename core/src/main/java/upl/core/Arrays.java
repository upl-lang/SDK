	...
	public class Arrays {
		...
		public static String[] concat (String[] first, String[]... rest) { // TODO
		...
		public static char[] processCharArray (int i, byte[] bytes, char[] chars) {
		...
		public static char[] toCharArray (byte[] bytes) {
			...
			for (int i = 0; i < bytes.length; ++i)
				chars = processCharArray (i, bytes, chars);
     ...
     */
		public static byte[] shiftLeft (byte[] b1, int bytes) {
			...
			java.lang.System.arraycopy (b1, bytes, result, 0, bytes);
		...
		/**
     * Shifts a char array to the left
     *
     * @param array the array
     * @param length the number of shifts (shifts 0 from right)
     * @return the resulting new array
     */
		public static char[] shiftLeft (char[] array, int length) {
			
			char[] result = new char[array.length - length];
			java.lang.System.arraycopy (array, length, result, 0, array.length - length);
		...
		/**
     * Shifts a char array to the right
     *
     * @param array the array
     * @param length the number of shifts (shifts 0 from right)
     * @return the resulting new array
     */
		public static char[] shiftRight (char[] array, int length) {
			
			char[] result = new char[length];
			java.lang.System.arraycopy (array, 0, result, 0, length);
		...
		public static byte[] getLeft (byte[] array, int size) {
			
			byte[] bytes = new byte[size];
			java.lang.System.arraycopy (array, 0, bytes, 0, size);
