  ...
  public class File extends java.io.File {
    ...
    public File (String... fileName) {
      this (Arrays.implode (DS, fileName, false));
    }
    ...
    public void getWriter () throws IOException {
      ...
      setBufferedWriter (new BufferedWriter (new OutputStreamWriter (fos)));
      
    }
    
    public void getAppendWriter () throws IOException {
      
      setBufferedWriter (new BufferedWriter (new FileWriter (this, true)));
    ...
    public File getResource () throws URISyntaxException {
      ...
      URL res = getClass ().getClassLoader ().getResource (toString ());
      return new File (res.toURI ().toString ());
      
    }
    
    public String getApplicationPath (Class<?> root) throws URISyntaxException {
      
      CodeSource codeSource = root.getProtectionDomain ().getCodeSource ();
      File rootPath = new File (codeSource.getLocation ().toURI ().getPath ());
      
      return rootPath.getParentFile ().getParent ();
      
    }
    
    public byte[] getBytes () throws IOException {
      return getStream ().getBytes ();
    }
