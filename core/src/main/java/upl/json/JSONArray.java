	...
	public class JSONArray {
		 ...
		 */
		public static Float checkFloat (float d) {
		...
		public RuntimeException typeMismatch (Object indexOrName, Object actual, String requiredType) {
		...
		public RuntimeException typeMismatch (Object actual, String requiredType) {
		...
		public JSONArray putPurge (JSONArray value) {
			...
			for (int i = 0; i < value.length (); i++)
				methods.put (value.get (i).toString ());
		...
		public Double getDouble (int index) {
			Object object = get (index);
			Double result = Struct.toDouble (object);
			if (result == null) {
		...
		public Integer getInt (int index) {
			Object object = get (index);
			Integer result = Struct.toInteger (object);
			if (result == null) {
		...
		public Long getLong (int index) {
			Object object = get (index);
			Long result = Struct.toLong (object);
			if (result == null) {
		...
		public String getString (int index) {
			Object object = get (index);
			String result = Struct.toString (object);
			if (result == null) {
