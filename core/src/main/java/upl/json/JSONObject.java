  ...
  // Note: this class was written without inspecting the non-free upl.json sourcecode.
  ...
  public class JSONObject extends Struct {
    ...
    public JSONObject (JSONTokener readFrom) {
      ...
      if (object instanceof JSONObject) {
        this.object = ((JSONObject) object).object;
      } else {
    ...
    public JSONObject put (String name, boolean value) {
      ...
      object.put (checkName (name), value);
    ...
    public JSONObject put (String name, double value) {
      object.put (checkName (name), JSON.checkDouble (value));
      return this;
    }
    ...
    public JSONObject accumulate (String name, Object value) {
      Object current = object.get (checkName (name));
      if (current == null) {
        return put (name, value);
      }
    ...
    /**
     * Returns the value mapped by {@code key} if it exists and is a boolean or can be coerced to a boolean.
     *
    ...
    public Float getFloat (String name) {
      ...
      Object object = get (name);
      Float result = Objects.toFloat (object);
     ...
     * returned iterator supports {@link Iterator#remove() remove}, which will remove the corresponding mapping from this object. If this object is modified after the iterator is returned, the iterator's behavior is undefined. The order of the keys is undefined.
     */
     ...
     */
    public JSONArray names () { // TODO
      return object.isEmpty () ? null : new JSONArray (new ArrayList<> (object.keySet ()));
    }
    ...
    public String implode (String sep1, String sep2) {
      return object.implode (sep1, sep2);
    }
    ...
    public JSONObject extend (Map<?, ?> prefs) {
      ...
      for (Object key : prefs.keySet ()) {
        ...
        if (!object.containsKey (key.toString ()))
          object.put (key.toString (), prefs.get (key));
    ...
    public String[] toStringArray () {
      ...
      for (String key : object.keySet ()) {
        ...
        strings[i] = String.valueOf (object.get (key));
        i++;
    ...
    public String[] toStringArray (String[] keys) {
      ...
      for (int i = 0; i < keys.length; ++i)
        strings[i] = String.valueOf (object.get (keys[i]));
    ...
    public String[] toStringArray (JSONObject defs) {
      ...
      for (int i = 0; i < keys.length (); ++i)
        strings[i] = String.valueOf (object.get (keys.getString (i)));
    ...
    public String[] toStringArray (Map<?, ?> prefs) {
      ...
      for (Object key : prefs.keySet ()) {
        ...
        strings[i] = String.valueOf (object.get (key.toString ()));
        ++i;
    ...
    public JSONObject toJSONObject (String[] prefs) {
      ...
      for (int i = 0; i < prefs.length; ++i)
        output.put (prefs[i], object.get (i));
