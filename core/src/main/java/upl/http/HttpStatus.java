  ...
  public enum HttpStatus implements Status {
    ...
    CLIENT_ERROR_REQUESTED_HOST_UNAVAILABLE (434, "Requested host unavailable"), // OLD
    CLIENT_ERROR_RETRY_WITH (449, "Retry With"), // OLD
    CLIENT_ERROR_UNAVAILABLE_FOR_LEGAL_REASONS (451, "Unavailable For Legal Reasons"),
    CLIENT_ERROR_UNRECOVERABLE_ERROR (456, "Unrecoverable Error"), // OLD
    ...
    SERVER_ERROR_BADWIDTH_LIMIT_EXCEEDED (509, "Bandwidth Limit Exceeded"), // OLD
