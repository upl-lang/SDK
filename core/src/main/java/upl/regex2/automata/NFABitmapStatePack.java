...
public class NFABitmapStatePack {
    protected final long[] stateBitmap;
    protected final NFABitmapStateManager manager;

    protected volatile boolean writable = true;
    protected List<NFABitmapState> asList = null;
    ...
    protected long[] newStateBitmap(int stateCount) {
    ...
    protected List<NFABitmapState> toList() {
