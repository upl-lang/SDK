     ...
     */
		public final void writeValue (Object v) {
			if (v == null) {
				...
				writeInt (VAL_MAP);
				writeMapInternal ((Map<String, Object>) v);
     ...
     */
		...
		/*package*/
		static native FileDescriptor dupFileDescriptor (FileDescriptor orig)
			throws IOException;
     ...
     */
		...
		protected Serializable readSerializable (final ClassLoader loader) {
			String name = readString ();
			if (name == null) {
