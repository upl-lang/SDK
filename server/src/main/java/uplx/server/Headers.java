     ...
     */
		public Headers readHeaders (BufferedReader reader) throws ServerException {
     ...
     */
		public Map<String, String> getParams (String name) {
			...
			for (String param : Server.split (get (name), ";", -1)) {
				...
				String val = pair.length () == 1 ? "" : Strings.trimStart (Strings.trimEnd (pair.get (1), "\""), "\"");
     ...
     */
		...
		public String toString () {
			return upl.core.Arrays.implode ("\n", headers);
		}
