	...
	public abstract class TextHandler extends HttpHandler {
		...
		protected abstract StringTemplate onContent (Application app, Request request, Response response) throws ServerException;
