	...
	public abstract class JSONHandler extends Handler<Request, Response> {
		...
		protected abstract String onContent (Application app, Request request, Response response) throws ServerException;
