	...
	/**
	 * The {@code Server} class implements a lightweight HTTP server.
	 * <p>
	 ...
	 * @since 2008-07-24
	 */
	public abstract class Server<Request extends uplx.server.Request, Response extends uplx.server.Response> extends ServerSocket {
		
		public Application app;
		
		public static final String VERSION = "1.0";
		
		protected ServerThread<Request, Response> thread;
		public Router<Request, Response> router;
     ...
     */
		public Server (Application app) throws IOException {
			this (app, "localhost");
		}
     ...
     * Note: the {@link #start()} method must be called to start accepting connections.
     */
		public Server (Application app, String address) throws IOException {
			this (app, address, 80);
		}
     ...
     */
		...
		public Server<?, ?> setListener (ServerListener listener) {
     ...
     */
		...
		public Server<Request, Response> setRouter (Router<Request, Response> router) {
     ...
     */
		public static List<String> split (String list, boolean lower) {
     ...
     */
		public static List<String> split (String str, String delimiters, int limit) {
     ...
     */
		...
		public Server<Request, Response> setThread (ServerThread<Request, Response> thread) {
		...
		public Server<Request, Response> setCharset (Charset charset) {
     ...
     */
		public void start () throws ServerException {
			...
			try {
				...
				for (VirtualHost host : hosts.values ())
				...
				while (true) {
					...
					thread.server = router.server = this;
