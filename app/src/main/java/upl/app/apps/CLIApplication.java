	...
	public abstract class CLIApplication extends Application {
		...
		protected abstract void onShow () throws ApplicationException;
		protected void onInit () throws ApplicationException {}
